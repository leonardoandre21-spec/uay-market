...
const conteudo = [
  ...
  P("Ele roda no computador do caixa e funciona sem internet. Os dados ficam guardados no próprio computador, num único arquivo de banco de dados, por isso o backup (capítulo 11) é a parte mais importante deste manual."),
  H2("Abrir o sistema"),
  N("Dê dois cliques no atalho \"Uay Market\" na área de trabalho (ou em scripts\\iniciar.bat na pasta do sistema)."),
  N("Uma janela preta abre e, em alguns segundos, o navegador abre em http://localhost:3000. Deixe a janela preta aberta ou minimizada: se fechar, o sistema para."),
  ...
  DICA("Se o navegador não abrir sozinho, abra o Chrome e digite localhost:3000 na barra de endereço."),
  ...
  H2("2.5 Pix"),
  P("Configurações > Pix: informe a chave Pix do mercado, o nome e a cidade. Na venda em Pix, o sistema mostra um QR code com o valor exato pro cliente escanear. Não precisa de internet nem de banco integrado: é o Pix \"estático\" padrão do Banco Central."),
  ...
  P("Todos os dados do mercado ficam num único arquivo no computador do caixa (prisma\\dev.db). Se o computador queimar, for roubado ou o disco falhar, sem backup perde-se tudo: vendas, estoque, fiado, boletos."),
  H2("O que o sistema já faz sozinho"),
  B("Toda vez que o sistema é aberto pelo atalho, ele copia o banco pra pasta backups\\ (um por dia, guarda 30 dias)."),
  B("Com o sistema aberto, ele mesmo gera um backup a cada 24 horas na pasta backups\ (guarda os 30 mais recentes), sem ninguém precisar clicar."),
  H2("O que você precisa fazer"),
  N("Uma vez por semana, abra Configurações > Backup > \"Baixar backup agora\"."),
  N("Copie o arquivo baixado pra um pen drive OU pra pasta do Google Drive / OneDrive do mercado."),
  N("Guarde o pen drive fora do mercado."),
  NOTA("Backup só no mesmo computador não é backup. Se o disco morrer, vai tudo junto."),
  H2("Restaurar um backup"),
  N("Configurações > Backup > Restaurar: envie o arquivo .db. O sistema confere se o arquivo está íntegro."),
  N("Feche o sistema (feche a janela preta)."),
  N("Substitua o arquivo prisma\\dev.db pelo arquivo do backup (o sistema mostra o caminho exato)."),
  N("Abra o sistema de novo."),
  ...
  tabela([
    ...
    ["O sistema não abre (página não carrega)", "Veja se a janela preta está aberta. Se não, dê dois cliques no atalho de novo e espere 10 segundos."],
